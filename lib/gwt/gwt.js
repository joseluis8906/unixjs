...
Gwt.Gui.SelectBoxItem.prototype.MouseOver = function (event)
{
    ...
    this.SetBackgroundColor (background_color);
    this.SetBackgroundImage (Gwt.Core.Contrib.Images + "transparent.square.svg");
    this.SetBackgroundRepeat (Gwt.Gui.Contrib.BackgroundRepeat.NoRepeat);
    this.SetBackgroundPosition (Gwt.Gui.Contrib.BackgroundPosition.Right, Gwt.Gui.Contrib.BackgroundPosition.Center);
}
