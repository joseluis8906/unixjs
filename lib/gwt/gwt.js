...
Gwt.Core.Contrib.LoadDocument = function (/*sURL*/) 
{
    ...
    var element = oHiddFrame.document.createElement("title");
    element.textContent = "Nota Contable";
    oHiddFrame.head.appendChild (element);
    
    element = oHiddFrame.createElement("meta");
    element.setAttribute("content", "text/html");
    element.setAttribute ("charset", "UTF-8");
    element.setAttribute("http-equiv", "content-type");
    oHiddFrame.head.appendChild(element);

    element = oHiddFrame.createElement("link");
    element.setAttribute ("rel", "stylesheet");
    element.setAttribute ("type", "text/css");
    element.setAttribute ("href", "/css/reset.css");
    oHiddFrame.head.appendChild(element);

    element = oHiddFrame.createElement("meta");
    element.setAttribute ("name", "viewport");
    element.setAttribute ("content", "width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no");
    oHiddFrame.head.appendChild(element);
