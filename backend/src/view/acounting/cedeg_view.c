...
int accounting_cedeg_view_pdf (struct http_request *req)
{
    ...
    comic_regular = HPDF_LoadTTFontFromFile (pdf, "media/fonts/comic.ttf", HPDF_TRUE);
    comic_bold = HPDF_LoadTTFontFromFile (pdf, "media/fonts/comicbd.ttf", HPDF_TRUE);
    calibri = HPDF_LoadTTFontFromFile (pdf, "media/fonts/calibri.ttf", HPDF_TRUE);
    calibri_bold = HPDF_LoadTTFontFromFile (pdf, "media/fonts/calibribd.ttf", HPDF_TRUE);
    times_bold = HPDF_LoadTTFontFromFile (pdf, "media/fonts/timesbd.ttf", HPDF_TRUE);

    page = HPDF_AddPage (pdf);
    HPDF_Page_SetSize (page, HPDF_PAGE_SIZE_LETTER, HPDF_PAGE_PORTRAIT);
    
    logo = HPDF_LoadPngImageFromFile (pdf, "media/images/logoCdi.png");
